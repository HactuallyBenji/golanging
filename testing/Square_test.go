...
// test if the Square function produces the correct output for a particular scenario a=2
...
// use table-driven testing to test the function in various situations
func TestSquareTableDriven(t *testing.T) {
   ...
   // iterate through the each test table entry
